...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field makers on 'Challenge'
        m2m_table_name = db.shorten_name(u'campaign_challenge_makers')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('challenge', models.ForeignKey(orm[u'campaign.challenge'], null=False)),
    ...
    def backwards(self, orm):
        # Removing M2M table for field makers on 'Challenge'
        db.delete_table(db.shorten_name(u'campaign_challenge_makers'))
    ...
    models = {
        ...
        u'campaign.challenge': {
            ...
            'makers': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'symmetrical': 'False'}),
