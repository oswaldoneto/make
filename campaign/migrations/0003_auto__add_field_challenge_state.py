...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Challenge.state'
        db.add_column(u'campaign_challenge', 'state',
                      self.gf('django.db.models.fields.CharField')(default='NW', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.state'
        db.delete_column(u'campaign_challenge', 'state')
